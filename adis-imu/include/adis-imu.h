...
#define     PINSEL_ADIS_RST                 (PINSEL0  = (PINSEL0  & ~(0x3 << P0_0_PINSEL0))  | (GPIO_PINSEL0   << P0_0_PINSEL0))
#define     PINMODE_ADIS_RST_PULLUP         (PINMODE0 = (PINMODE0 & ~(0x3 << P0_18_PINSEL1)) | (P0_PULLUP_MODE << P0_0_PINSEL0))
...
#define     FIO_ADIS_RST                    (FIO0DIR |= (1<<0))

#define     ADIS_RST_HIGH                   (FIO0SET |= (1<<0))
#define     ADIS_RST_LOW                    (FIO0CLR |= (1<<0))

#define     ADIS_RST_MSECS                  1000

#define     ADIS_IMU_LEDFLASHES             5

/*!
 * Can write to the upper or lower 8 bits of a register
 */
typedef enum {
	ADIS_LOWER = 0,
	ADIS_UPPER = 1
...
/*!
 * Each 16 bit register has two 7 bit addresses: One for the upper byte and
 * one for the lower.
 *
 */
// ADIS Registers
